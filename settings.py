...
# ================================
TX_ANT   = 8                        # BS  發射天線數 M
RIS_UNIT = 128                      # RIS 反射單元數 N
UAV_COMM = 4                        # 通訊 UE 數 K
...
INJECTION_SAMPLES  = 1000                 # 一個估測通道要有多少誤差通道
...
BASELINE_DIR = os.path.join(BASE_RUN_DIR, "baseline")       #
