...
SENSING_LOSS_WEIGHT    = 1000.0      # 罰則係數 λ1 (0~500)
...
def random_points_on_circle(center, radius, num_points):
    cx, cy = center
    angles = np.random.uniform(0.0, 2.0 * np.pi, size=num_points)
    return [
...
# 訓練/驗證/測試
# ================================
EPOCHS          = 30        # 訓練輪數 一個epoch=MINIBATCHES*BATCH_SIZE 次
